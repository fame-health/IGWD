...
class CompletePatientProfileRequest extends BaseApiRequest
{
    public function rules(): array
    {
        $patientId = $this->user()?->patient_id;

        return [
            'name' => ['required', 'string', 'max:255'],
            'medical_record_number' => ['nullable', 'string', 'max:255', Rule::unique('patients', 'medical_record_number')->ignore($patientId)],
